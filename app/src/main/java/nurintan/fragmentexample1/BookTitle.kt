package nurintan.fragmentexample1
...
import nurintan.fragmentexample1.databinding.BookTitlesBinding
...
class BookTitle : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        container: ViewGroup?,
        savedInstanceState: Bundle?): View { _binding = BookTitlesBinding.inflate(inflater, container, false)
        return binding.root
    }
